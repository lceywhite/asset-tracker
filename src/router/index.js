...
const routes = [
  ...
  },
  {
    path: "/plans/:id/carry",
    name: "PlanCarry",
    component: () => import("@/components/trip/TripCarryListEditor.vue"),
    meta: { hideTabBar: true },
  },
  {
    path: "/plans/:id/carry/:containerId/items",
    name: "PlanItemPicker",
    component: () => import("@/components/trip/TripItemLibraryPicker.vue"),
    meta: { hideTabBar: true },
  },
  {
    path: "/plans/:id/check/:kind?",
    name: "PlanCheck",
    component: () => import("@/views/TripCheckView.vue"),
    meta: { hideTabBar: true },
  },
